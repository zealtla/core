...
void Unit::Kill(Unit* pVictim, SpellEntry const *spellProto, bool durabilityLoss)
{
	...
	{		
		...
		char pmsg [300];		
		snprintf(pmsg,300,"|cffFF0000[PVP]:|r|cffFFD700 %s|r %s|cff00FF00%s|r  |cffED00FF杀死了→|r%s|cff00FF00 %s。|r", zoneName.c_str(), kvipname.c_str(), killname, vvipname.c_str(), victimname);
